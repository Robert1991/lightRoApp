/* global TableDataHandle, ListDataHandle */
function deleteDeviceFromDb(buttonDelete) {
    function getDeviceNameFromTableRow(tableRow) {
        return TableDataHandle.getDeviceRowCellValue(tableRow,'name');
    }
    
    var tableRow = TableDataHandle.getRowFromElement(buttonDelete);
    ...
    if(_confirmAction("Do you really want to delete the settings for " + deviceName)) {
       var rowIndex = TableDataHandle.getRowIndexFromElement(buttonDelete);
